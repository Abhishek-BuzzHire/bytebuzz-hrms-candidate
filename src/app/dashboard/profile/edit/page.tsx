...
function resolveResume(resumes: any): Resume | null {
  let arr: Resume[] = [];
  if (Array.isArray(resumes)) arr = resumes;
  else if (resumes?.results && Array.isArray(resumes.results)) arr = resumes.results;
  else if (resumes && typeof resumes === 'object') arr = [resumes];
