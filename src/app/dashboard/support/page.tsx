                ...
                <Card className="shadow-sm border-gray-200 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 overflow-hidden group">
                    ...
                    <CardContent className="space-y-3">
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            ...
                            <a href="mailto:shivam.buzzhire@gmail.com" className="text-indigo-600 hover:text-indigo-700 font-semibold flex items-center gap-2">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            ...
                            <a href="mailto:support@buzzhire.com" className="text-indigo-600 hover:text-indigo-700 font-semibold flex items-center gap-2">
                                support@buzzhire.com
                                <Mail className="w-4 h-4" />
                            </a>
                        </div>
                    </CardContent>
                ...
                <Card className="shadow-sm border-gray-200 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 overflow-hidden group">
                    ...
                    <CardContent className="space-y-3">
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            ...
                            <p className="text-gray-900 font-semibold">HD-2024-BUZZHIRE</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
